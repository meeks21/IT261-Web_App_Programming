...
<body>
    <diV class="wrapper">
        ...
        <nav class="top_nav">
            <a href="#">Home</a>
            <a href="adder.php">Troubleshooting</a>
            <a href="website/daily.php">Daily</a>
            <a href="website/calculator-index.php">Calculator</a>
            <a href="#">Contact</a>
            <a href="#">gallery</a>
        </nav>
        <div class="banner">
        ...
        <aside>
            ...
            <div class="portal-aside-container">
            <h4>Class Exercises</h4>
            <h5>Week 2</h5>
            ...
            <ul class="assignment_list">
                ...
                <li><a href="weeks/week4/celsius-form.php">celsius-form.php</a></li>
        ...
        <footer>
            <nav class="footer_nav">
                <a href="https://validator.w3.org/check?uri=referer"><ion-icon name="logo-html5" target="_blank"></ion-icon></a>
                <a href="https://jigsaw.w3.org/css-validator/check?uri=referer"><ion-icon name="logo-css3"></ion-icon></a>
            </nav>
        </footer>
    </div>
